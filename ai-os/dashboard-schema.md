...
> - `project_id`: `JREC-01` / `FREEE-02` / `JWEB-03` / `JBIZ-04` / `HAIKI-05` / `AIOS-06` / `AINV-07`
...
- `JREC-01` uses `【毎日記録】来店管理施術録ver3.1` as the current source-of-truth sheet.
- `JWEB-03` remains visible only as a migration / archive candidate and should not be treated as the current source of truth.
- `HAIKI-05` uses `workspace/waste-report-system` as the canonical local folder path.
