...
作成: 2026-03-05 / 最終更新: 2026-05-07（WEB-3 月次申請フロー LiveCheck 8 PASS・CLOSED）
...
│
├─ 【柔整GAS】───────────────────────────────────────────────────→
│     施術明細upsert ✅ → WEB-1〜3 ✅ → WEB-3.4 PDF生成 → TC01〜10
│
├─ 【freee自動化】───────────────────────────────────────────────→
...
| W-7 | WEB-3.4 申請書 PDF 生成 | Web UI から申請書 PDF を生成するフロー | ⏸ 待機 |
