...
作成: 2026-03-05 / 最終更新: 2026-03-23（腰痛評価シートシステム JEVAL-01 設計フェーズ完了・ロードマップ追加）
...
🟢 後半（新規開発・中長期）
   6. 腰痛評価シート JEVAL-01: Phase 1 シート生成 → Phase 2 ロジック実装 → Phase 5 Claude API連携
   7. 接骨院経営戦略AI: 数値入力 → Claude API実装
   8. 廃棄物日報システム: 要件定義 → 設計 → 実装
```
