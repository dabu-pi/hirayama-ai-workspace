...
作成: 2026-03-05 / 最終更新: 2026-05-07（B-2 インフラ検証完了・60 PASS / 2 SKIP / 0 FAIL）
...
│
├─ 【柔整GAS】───────────────────────────────────────────────────→
│     施術明細upsert ✅ → WEB-1〜3.4 ✅ → B-1 fixture 57/57 ✅ → 本番 deploy
│
├─ 【freee自動化】───────────────────────────────────────────────→
...
| W-8 | TC01〜TC10 実機テスト | TESTCASES.md 全10ケースのスプレッドシート実機確認 | ⏸ 待機 |
...
| B-2 | 施術明細→申請書転記データの出力確認 | verifyMonthlyClaimData_V3 / 6 PASS / NO_PATIENTS_THIS_MONTH | 🔄 インフラ完了・実データ確認待ち |
| B-3 | SPEC.md §14（ステップ④）仕様更新 | ドキュメント整合 | ⏸ 待機 |
