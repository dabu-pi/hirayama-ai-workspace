...
[
  {
    "url": "https://example.com/images/OOCY16003LG-1.jpg",
...
```json
{
  ...
  "images": [
    ...
    {
      "url": "https://example.com/images/OOCY16003LG-2.jpg",
...
| `商品名` | `name`, `seo.title`, `images[].alt`, `searchText` | `seo.title` 未入力時は商品名 + サイト名で補完 |
...
| `画像1〜3` | `images[]` | 空欄を除外して配列化し、先頭を `isMain=true` |
...
| 画像URLの保管先 | v0 ではURL文字列のまま。Drive直リンク/オブジェクトストレージ/CDN の最終方式は別途決定する |
