...
function setupNsCommentsSheet(ss) {
  ...
  const rows = [
    // ── カテゴリ 1: 評価まとめ ──
    ['NS_REDFLAG_SUMMARY',        1, '評価まとめ', '【要注意】赤旗スクリーニングで陽性所見があります。施術開始前に医療連携の必要性を判断してください。', '施術者', 'NS_FLAG_REDFLAG', today],
    ['NS_MYELOPATHY_SUMMARY',     1, '評価まとめ', '評価まとめ: 頚髄症を疑う所見があります（手の巧緻性低下 / 両側放散）。本日の施術は保留または最小限とし、整形外科受診を優先してください。', '施術者', 'NS_FLAG_MYELOPATHY', today],
    ['NS_RADICULOPATHY_SUMMARY',  1, '評価まとめ', '評価まとめ: 片側の上肢放散・しびれがあります（神経根障害の可能性）。施術は神経根刺激回避を前提に進めてください。', '施術者', 'NS_FLAG_RADICULOPATHY', today],
    ['NS_CHRONIC_LIFE_SUMMARY',   1, '評価まとめ', '評価まとめ: 慢性期かつ生活負荷が高い状態です。施術と生活習慣改善を並行して進める方針を検討してください。', '施術者', 'NS_FLAG_CHRONIC + NS_FLAG_LIFESTYLE_HIGH', today],
    ['NS_CHRONIC_SUMMARY',        1, '評価まとめ', '評価まとめ: 慢性期です。セルフケア習慣化と姿勢再教育を軸に進めると改善しやすい状態です。', '施術者', 'NS_FLAG_CHRONIC', today],
    ['NS_LIFESTYLE_SUMMARY',      1, '評価まとめ', '評価まとめ: 症状の主な持続要因として生活負荷が高い状態です。施術と並行して負荷軽減指導・姿勢再教育を早期に入れることを推奨します。', '施術者', 'NS_FLAG_LIFESTYLE_HIGH', today],
    ['NS_STANDARD_SUMMARY',       1, '評価まとめ', '評価まとめ: 神経症状なし。施術中心で進めながら、セルフケアを段階的に導入してください。', '施術者', '（標準）', today],
    // ── カテゴリ 2: 注意すべき所見 ──
    ['NS_REDFLAG_CAUTION',        2, '注意すべき所見', '頚部特有の危険所見が報告されています。施術前に受診・精査を検討してください。', '施術者', 'NS_FLAG_REDFLAG', today],
    ...
    ['NS_RADICULOPATHY_CAUTION',  2, '注意すべき所見', '神経根障害の可能性があります。施術後に上肢症状が増悪する場合は施術を中止し再評価してください。3〜4回で改善傾向がない場合は医療連携を検討します。', '施術者', 'NS_FLAG_RADICULOPATHY', today],
    ['NS_LIFESTYLE_CAUTION',      2, '注意すべき所見', '生活負荷が高い状態が症状の持続要因として疑われます。施術だけでは根本改善しにくい状態です。負荷軽減の指導を早期に組み込んでください。', '施術者', 'NS_FLAG_LIFESTYLE_HIGH', today],
    ...
    ['NS_REDFLAG_REFERRAL',       8, '医療連携条件', '【医療連携: 要検討】危険所見があります。整形外科・内科への受診を勧奨し、経過を確認してから施術を継続するか判断してください。', '施術者', 'NS_FLAG_REDFLAG', today],
