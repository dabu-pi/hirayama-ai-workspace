...
begin
  ...
  values
    ...
    (w1, 1,
      ...
      'T1 スクワット 5×3+、T2 ベンチプレス 3×10、T3 ラットプルダウン 3×15+'),
    (w1, 2,
      ...
      'T1 オーバーヘッドプレス 5×3+、T2 デッドリフト 3×10、T3 ダンベルロー 3×15+'),
    (w1, 3,
      ...
      'T1 ベンチプレス 5×3+、T2 スクワット 3×10、T3 ラットプルダウン 3×15+'),
    -- Week 2
    (w2, 1,
      ...
      'T1 デッドリフト 5×3+、T2 オーバーヘッドプレス 3×10、T3 ダンベルロー 3×15+'),
    (w2, 2,
      'スクワット中心の日 — T1 スクワットは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 ベンチプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3は最終セットが25回できたら次回から重量を増やします。',
      'T1 スクワット 5×3+、T2 ベンチプレス 3×10、T3 ラットプルダウン 3×15+'),
    (w2, 3,
