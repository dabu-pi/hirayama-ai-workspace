...
begin
  ...
  values
    (w1, 1, 'スクワット中心の日 — T1 スクワットは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 ベンチプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 スクワット 5×3+、T2 ベンチプレス 3×10、T3 ラットプルダウン 3×15+'),
    (w1, 2, 'プレス中心の日 — T1 オーバーヘッドプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 デッドリフトは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 オーバーヘッドプレス 5×3+、T2 デッドリフト 3×10、T3 ダンベルロー 3×15+'),
    (w1, 3, 'ベンチプレス中心の日 — T1 ベンチプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 スクワットは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 ベンチプレス 5×3+、T2 スクワット 3×10、T3 ラットプルダウン 3×15+'),
    (w2, 1, 'デッドリフト中心の日 — T1 デッドリフトは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 オーバーヘッドプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 デッドリフト 5×3+、T2 オーバーヘッドプレス 3×10、T3 ダンベルロー 3×15+'),
    (w2, 2, 'スクワット中心の日 — T1 スクワットは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 ベンチプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 スクワット 5×3+、T2 ベンチプレス 3×10、T3 ラットプルダウン 3×15+'),
    (w2, 3, 'プレス中心の日 — T1 オーバーヘッドプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 デッドリフトは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 オーバーヘッドプレス 5×3+、T2 デッドリフト 3×10、T3 ダンベルロー 3×15+'),
    (w3, 1, 'ベンチプレス中心の日 — T1 ベンチプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 スクワットは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 ベンチプレス 5×3+、T2 スクワット 3×10、T3 ラットプルダウン 3×15+'),
    (w3, 2, 'デッドリフト中心の日 — T1 デッドリフトは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 オーバーヘッドプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 デッドリフト 5×3+、T2 オーバーヘッドプレス 3×10、T3 ダンベルロー 3×15+'),
    (w3, 3, 'スクワット中心の日 — T1 スクワットは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 ベンチプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 スクワット 5×3+、T2 ベンチプレス 3×10、T3 ラットプルダウン 3×15+'),
    (w4, 1, 'プレス中心の日 — T1 オーバーヘッドプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 デッドリフトは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 オーバーヘッドプレス 5×3+、T2 デッドリフト 3×10、T3 ダンベルロー 3×15+'),
    (w4, 2, 'ベンチプレス中心の日 — T1 ベンチプレスは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 スクワットは 3×10 → 3×8 → 3×6 の順で進みます。T3 ラットプルダウンは最終セットが25回できたら次回から重量を増やします。', 'T1 ベンチプレス 5×3+、T2 スクワット 3×10、T3 ラットプルダウン 3×15+'),
    (w4, 3, 'デッドリフト中心の日 — T1 デッドリフトは 5×3+ → 6×2+ → 10×1+ の順に進みます。規定回数をこなせなくなったら5RMを再テストし、85%の重量から再スタートします。T2 オーバーヘッドプレスは 3×10 → 3×8 → 3×6 の順で進みます。T3 ダンベルローは最終セットが25回できたら次回から重量を増やします。', 'T1 デッドリフト 5×3+、T2 オーバーヘッドプレス 3×10、T3 ダンベルロー 3×15+');
