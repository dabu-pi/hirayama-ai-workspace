...
begin
  ...
  values
    (w1, 1, 'A1 — T1 Squat: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Bench: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A1: T1 Squat 5×3+, T2 Bench Press 3×10, T3 Lat Pulldown / Leg Curl / Triceps Pushdown 3×15+'),
    (w1, 2, 'B1 — T1 Press: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Deadlift: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B1: T1 Overhead Press 5×3+, T2 Deadlift 3×10, T3 DB Row / Lateral Raise / Back Extension 3×15+'),
    (w1, 3, 'A2 — T1 Bench: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Squat: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A2: T1 Bench Press 5×3+, T2 Squat 3×10, T3 Lat Pulldown / Incline DB Press / Leg Extension 3×15+'),
    (w2, 1, 'B2 — T1 Deadlift: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Press: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B2: T1 Deadlift 5×3+, T2 Overhead Press 3×10, T3 DB Row / Romanian Deadlift / Lateral Raise 3×15+'),
    (w2, 2, 'A1 — T1 Squat: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Bench: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A1: T1 Squat 5×3+, T2 Bench Press 3×10, T3 Lat Pulldown / Leg Curl / Triceps Pushdown 3×15+'),
    (w2, 3, 'B1 — T1 Press: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Deadlift: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B1: T1 Overhead Press 5×3+, T2 Deadlift 3×10, T3 DB Row / Lateral Raise / Back Extension 3×15+'),
    (w3, 1, 'A2 — T1 Bench: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Squat: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A2: T1 Bench Press 5×3+, T2 Squat 3×10, T3 Lat Pulldown / Incline DB Press / Leg Extension 3×15+'),
    (w3, 2, 'B2 — T1 Deadlift: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Press: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B2: T1 Deadlift 5×3+, T2 Overhead Press 3×10, T3 DB Row / Romanian Deadlift / Lateral Raise 3×15+'),
    (w3, 3, 'A1 — T1 Squat: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Bench: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A1: T1 Squat 5×3+, T2 Bench Press 3×10, T3 Lat Pulldown / Leg Curl / Triceps Pushdown 3×15+'),
    (w4, 1, 'B1 — T1 Press: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Deadlift: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B1: T1 Overhead Press 5×3+, T2 Deadlift 3×10, T3 DB Row / Lateral Raise / Back Extension 3×15+'),
    (w4, 2, 'A2 — T1 Bench: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Squat: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'A2: T1 Bench Press 5×3+, T2 Squat 3×10, T3 Lat Pulldown / Incline DB Press / Leg Extension 3×15+'),
    (w4, 3, 'B2 — T1 Deadlift: 5×3+ → 6×2+ → 10×1+, retest 5RM and restart at 85%. T2 Press: 3×10 → 3×8 → 3×6. T3: add weight when final set reaches 25 reps.',
            'B2: T1 Deadlift 5×3+, T2 Overhead Press 3×10, T3 DB Row / Romanian Deadlift / Lateral Raise 3×15+');
