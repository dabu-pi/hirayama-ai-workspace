...
const PROGRAM_GOAL_BY_SLUG: Record<string, string> = {
  ...
  "gzclp-base-v2":
    "週4回のトレーニングで完全なA1/B1/A2/B2サイクルをこなし、筋力と筋量を効率よく積み上げる。",
  "gzclp-base-v2-4day":
    "週4回のトレーニングで完全なA1/B1/A2/B2サイクルを毎週こなし、筋力と筋量を効率よく積み上げる。",
  "big3-2day":
...
const PROGRAM_OVERVIEW_BY_SLUG: Record<string, string> = {
  "gzclp-base":
    "A1/B1/A2/B2の4パターンを週3日でローテーションするGZCLP基礎プログラム。T1は5×3+の高強度セット、T2は3×10の練習セット、T3は3×15+のアクセサリー種目で構成されています。バーベルトレーニング初心者に最適なプログラムです。",
  "gzclp-base-v2":
    "完全なA1/B1/A2/B2サイクルを毎週繰り返す改良版GZCLP。各セッション: T1メイン5×3+、T2練習3×10、T3アクセサリー。種目交換グループに対応し、バリエーションを持たせながら継続できます。",
  "gzclp-base-v2-4day":
    "完全なA1/B1/A2/B2サイクルを毎週繰り返す週4版GZCLP。各セッション: T1メイン5×3+、T2練習3×10、T3アクセサリー3種（主種目の動作パターンに応じた選択式）。週4回でより多くのボリュームを確保できます。",
  "big3-2day":
