...
| F-01-5 | live 実行できない環境でも mock fixture で再確認できる | 完了 |
| F-01-6 | `auto` モードで live 失敗時に fallback できる | Google Trends は完了、Google Suggest は将来拡張余地あり |
...
| F-04-4 | commercial / discontinued フィルタと整合する | 検証済み |
| F-04-5 | metric を含める / 除く比較ができる | 完了 |
| F-04-6 | source / metric ごとの寄与を後から追える | 完了 |
...
| NF-06 | Google Trends や Google Suggest を絶対需要の代理値として扱わない |
...
- Google Suggest を単体の人気スコアとして扱わない

## 次アクション

1. 第 3 ソース候補を 1 本追加して、GT + Suggest の偏りをさらに薄める
