...
## publish-ready artifact contract

- artifact の必須 version field は `schema_version`
- 現在の正式値は `publish-ready/v1`
- `run_batch.py --output-publish-artifact` は常に `schema_version="publish-ready/v1"` を埋める
- `render_publish_markdown.py` は compare / ranking 分岐より前に `schema_version` を検証する
- compare artifact は `public_summary.compare_summary` を持てる
...
- v1 renderer は `publish-ready/v1` のみ正式対応
- `schema_version` 欠落 artifact は legacy とみなし、今回は受理しない
- unsupported version は、受信 version と supported version を含むエラーで停止する
...
- `run_batch.py` �� run �P�ʂ� source health �ŏ�������ǉ����A`ok / review_only / blocked`�Asource �� status�Areason�A`publish_ready` �� console �Ŋm�F�ł���悤�ɂ���
- source health �� console ���̑O����Ƃ��Ĉ����ACSV �͈��������s�f�[�^���S��ێ�����
- ���̎����ۑ�� GS / YT �� source-wide failure / partial failure fixture �� sidecar status artifact �̐����ł���

## 2026-04-09 Publish-ready Artifact �ǋL

- `run_batch.py` �� `--output-publish-artifact` �� `data/output/publish_ready_YYYYMMDD.json` ��o�͂ł���
- artifact �� internal CLI �� public layer �̊Ԃɒu���ŏ� JSON �ł���
- �܂߂���:
  `week`, `generated_at`, `publish_ready`, health summary, public summary, internal reference
- �܂߂Ȃ����:
  raw collector JSON, full CLI table, full CSV row dump, tuning detail
- `ok` �� artifact ���� + `publish_ready=true`
- `review_only` �� artifact ���� + `publish_ready=false`
- `blocked` �� artifact �𐶐����Ȃ�
...
## 2026-04-10 Markdown Renderer �ǋL

- `scripts/render_publish_markdown.py` �� artifact JSON ��ǂ�� `data/output/*.md` �𐶐�����
- renderer �� artifact only �œ��삵�ADB �� collector ��ĎQ�Ƃ��Ȃ�
