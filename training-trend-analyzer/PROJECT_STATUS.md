...
1. `docs/ROADMAP.md` の Phase 2 として、Google / YouTube Suggest の fallback 方針と失敗時挙動を文書化する
2. Phase 3 用に、seed / weight / threshold を compare evidence で見直す観測項目を整理する
3. 定期実行を見据えた最小 runbook を docs 化する
