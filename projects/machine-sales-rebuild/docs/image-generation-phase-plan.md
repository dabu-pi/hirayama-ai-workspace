...
| 元画像の取得方法が再現できる | 6商品・15画像で公開HTMLからの小規模回収に成功 | 一部達成 |
| 1商品に対して画像群を結びつけられる | `slug` / hidden `product-code` / 画像ファイル名で 6商品は整合 | 一部達成 |
...
2. 小規模回収の対象を少し広げて、公開側HTMLの再現性を確認する
