...
最終更新: 2026-05-02（Phase 6-I 実装・実機確認待ち）
...
| タスク | 内容 | 状態 |
|---|---|---|
| 6-I-1 | ホーム業務メニューに「売上・レポート」カードを追加 | 🔄 実機確認待ち |
| 6-I-2 | `?page=reports`（集計トップ）を新設 | 🔄 実機確認待ち |
| 6-I-3 | 日別集計・月別集計・メニュー別集計への入口カードを配置 | 🔄 実機確認待ち |
