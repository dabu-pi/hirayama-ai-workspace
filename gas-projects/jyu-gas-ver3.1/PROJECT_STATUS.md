...
最終更新: 2026-04-21（**T-SR-11/12/13/17/18 院長実機確認完了**）
...
| TC | 内容 | 状態 |
|---|---|---|
| T-SR-14 | case1のみ2部位 → 負傷名2・日数 | ⏳ 院長確認待ち（2部位患者が必要） |
| T-SR-15 | case1継続中にcase2発生 → 3者整合 | ⏳ 院長確認待ち（後回し可） |
| T-SR-16 | case1治癒後case2 → 3者整合 | ⏳ 院長確認待ち（後回し可） |

### 次にやること

1. **T-SR-14の確認**（2部位患者の施術録を1件出力して負傷名2・日数を確認）
2. T-SR-15/16は複合ケースが発生次第確認
...
| # | 内容 | 状態 | 必要な患者データ |
|---|---|---|---|
| T-SR-11 | case2 同月・初検料抑制 → 裏面列 | ⏳ 院長確認待ち | case2がいる月の施術録 |
| T-SR-12 | 再検料の裏面表示 | ⏳ 院長確認待ち | 再検来院がある月（毎月） |
| T-SR-13 | case2 別エピソード → 負傷名2 | ⏳ 院長確認待ち | case2患者 |
| T-SR-14 | case1 2部位 → 負傷名2・日数 | ⏳ 院長確認待ち | 2部位患者 |
| T-SR-15 | case1継続中にcase2発生 → 3者整合 | ⏳ 院長確認待ち（後回し可）| 複合ケース |
| T-SR-16 | case1治癒後case2 → 3者整合 | ⏳ 院長確認待ち（後回し可）| 治癒後別エピソードケース |
| T-SR-17 | 施術終了年月日プレースホルダー | ⏳ 院長確認待ち | 継続中患者（毎月） |
| T-SR-18 | 表面 earliest + 裏面 2件目情報 | ⏳ 院長確認待ち | case2患者（挿入位置のみ確認済み）|
