...
最終更新: 2026-04-20（**TC-B06 根本原因特定・正サービス `jrec-appgen-server` へ再デプロイ完了**）
...
| **TC-B05 施術証明欄自動入力** | ✅ **実装・デプロイ完了（2026-04-20）** — 実機確認は院長待ち |
...
| **TC-B05** | **施術証明欄の自動入力** | ✅ **実装完了** | — | 院長実機確認待ち |
| **TC-B06** | **施術証明欄 日付（暫定）** | ✅ **実装完了** | — | 暫定運用。院長実機確認待ち |
