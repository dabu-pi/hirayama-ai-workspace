...
最終更新: 2026-04-22（**copyInsurerToMaster_V3 セル番地依存→項目名依存へ移行済み — 実機確認待ち**）
...
⏳ **シート上での実機確認待ち** — 詳細チェックリストは下記 docs 参照  
→ `docs/JREC-01_copyInsurerToMaster_label_based_2026-04-22.md` の「実機確認チェックリスト」セクション
