...
| 3. 現状 | **WS-SR 表示追加修正 実装完了・実機確認待ち（T-SR-17 / T-SR-18）** |
| 4. 次の作業候補 | `clasp push` → `srGenerateDocument('P001', '2026-03')` 実機実行 → T-SR-17/T-SR-18 目視確認 |
...
| 方針 | 内容 |
|---|---|
| 施術終了年月日 | 転帰なし → `　　年　　月　　日`（プレースホルダー）/ 転帰あり → 実日付 / ケースなし → 空欄 |
