...
最終更新: 2026-04-02（**WS-SR 方針見直し: 0表示しない / blank維持 / 申請書ロジック保護優先で裏面再マッピング再調整中**）
...
**次の作業:** WS-SR — **裏面列再マッピング再確認 → 手動で T-SR-10v2 再テスト再実施** / 改善候補 I-1 保留中。
...
| 3. 現状 | **WS-SR は T-SR-10v2 再テスト中。実機OKはまだ未完了。** |
| 4. 次の作業候補 | `clasp push` → 裏面列位置 / blank維持の再確認 → 14/16/17 再判定 |
