...
最終更新: 2026-04-23（**Phase A 実運用テスト開始可能 — 記録・運用準備完了**）

---

## 📋 2026-04-23 Phase A 実運用テスト — 開始可能
...
| **Phase A** | 実運用テスト（コード変更なし）1〜2週間 | **▶ 実施中（2026-04-23〜）** |
...
**実受付業務での試用と記録。コード変更不要。**

1. 受付業務で Web App URL を開き、患者検索 → 自費明細保存を試みる
2. 問題・気づきを `docs/JREC-01_phaseA_operational_test_2026-04-23.md` §8 の記録テンプレートへ追記する
3. 1〜2週間後に §6「完了判定基準」を確認し、Phase B 移行を判断する
