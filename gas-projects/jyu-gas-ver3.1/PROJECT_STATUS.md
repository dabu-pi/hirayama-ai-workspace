...
最終更新: 2026-04-03（**WS-SR 表示追加修正: 施術終了年月日プレースホルダー / 表面 earliest case 優先 / 裏面 2件目負傷情報セクション**）
...
| 2件目情報の配置 | 裏面「整復・施療等の施術経過所見」列の来院データ後空行（空行なければ最終行末尾）|
...
- T-SR-18: 表面に 3/1 側の負傷原因情報だけ出るか / 裏面所見欄下部に【2件目負傷情報】が出るか
