...
- 治療→再発予防→ジム体験 導線方針を `strategy/gym-lead-design.md` に文書化
  - 自費月+20万円の主軸は自費成約（月4件目安）。ジム体験は補助売上ではなく再発予防とLTV延長の導線
  - 体験名称案「再発予防トレーニング体験」/「腰痛・肩こりを戻しにくくする運動体験」
  - 体験仕様叩き台: 20〜30分 / 既存自費患者向け / 初期無料想定
  - 体験導線の管理項目（案内→予約→実施→入会→断り理由）を定義
...
4. 再発予防トレーニング体験の具体的な運動種目・担当者分担を確定する（`strategy/gym-lead-design.md` 参照）
