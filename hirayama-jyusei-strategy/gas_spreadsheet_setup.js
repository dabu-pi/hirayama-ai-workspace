...
function setupPricing(ss) {
  ...
  const menus = [
    ...
    // 2026-03-23: 筋膜リリース（マッサージガン）→ ストレッチ（20分）に置換。menu_id: INS_OPTION_STRETCH20
    [3,  '保険施術オプション',      'INS_OPTION_STRETCH20', 'ストレッチ（20分）',
     '全身または部位ストレッチ', '20分',
     2200,  null,  '×', '1回',   false, '○', '確定', 'テスト期間中のため変更可。価格のみ変更時は menu_id 維持。'],
    // 2026-03-23: 温熱追加 → 電療追加（15分）に置換。menu_id: INS_OPTION_ELECTRO15
    [4,  '保険施術オプション',      'INS_OPTION_ELECTRO15', '電療追加（15分）',
     '電気療法追加', '15分',
     1200,  null,  '×', '1回',   false, '○', '確定', 'テスト期間中のため変更可。価格のみ変更時は menu_id 維持。'],
