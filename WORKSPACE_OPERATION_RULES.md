...
| プロジェクト | パス | branch |
|---|---|---|
| desktop-work-status-overlay | `desktop-work-status-overlay/` | master |
| wildboar-member-management | `wildboar-member-management/` | feature/wildboar-member-phase4 |
| training-program-platform-jp | `training-program-platform-jp/` | main |
| subsidy-grants-projects | `subsidy-grants-projects/` | main |
...
| hirayama-jyusei-strategy (JBIZ-04) | `hirayama-jyusei-strategy/` | 2026-05-11 に workspace 正本確定。standalone repo は保全のみ（push しない） |
